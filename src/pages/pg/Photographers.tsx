                                                            ...
                                                            <table className="pg-sub-table">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th style={{ textAlign: 'right' }}>Earnings (SEK)</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    {p.subEvents.map(e => (
                                                                        <tr key={e.id}>
                                                                            <td>
                                                                                <Link to="/admin/events/1" className="pg-user-link" style={{ fontSize: '0.8125rem' }}>
                                                                                    {e.name}
                                                                                </Link>
                                                                            </td>
                                                                            <td style={{ textAlign: 'right' }}>{e.published}</td>
                                                                            <td style={{ textAlign: 'right' }}>{e.sold}</td>
                                                                            <td style={{ textAlign: 'right' }}>{e.revenue.toLocaleString().replace(/,/g, ' ')}</td>
                                                                        </tr>
                                                                    ))}
                                                                </tbody>
                                                            </table>
