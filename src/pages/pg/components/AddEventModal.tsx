        ...
        <div className="auth-modal-overlay" onClick={onClose} style={{ zIndex: 1200, alignItems: 'center' }}>
            ...
            >
                ...
                <div className="modal-body-standard">
                    <div className="edit-profile-form-grid" style={{ gap: '20px' }}>
                        ...
                        <div className="edit-profile-full-width" style={{ borderTop: '1px solid #f0f0f0', paddingTop: '24px', marginTop: '8px' }}>
                        ...
                        <div className="edit-profile-full-width" style={{ borderTop: '1px solid #f0f0f0', paddingTop: '24px', marginTop: '8px' }}>
                            ...
                            />
                            <p style={{ margin: '8px 0 0 56px', fontSize: '0.8125rem', color: '#666', lineHeight: 1.4 }}>
